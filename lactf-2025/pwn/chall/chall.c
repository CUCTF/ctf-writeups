...
void edit_level()
{
    ...
    fgets(curr->data, 0x40, stdin); // Heap buffer overflow of curr->data
}
...
void test_level()
{
    ...
    printf("Level data: ");
    write(1, curr->data, sizeof(curr->data)); // Can this be used to leak data?
                                              // I'm not sure yet.
    putchar('\n');
}
...
void menu()
{
    ...
    switch (choice)
    {
        case 1:
            ...
            break;
        case 2:
            edit_level(); // Heap buffer overflow
            break;
        case 3:
            test_level();
            break;
